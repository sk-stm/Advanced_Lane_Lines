...
def test_print_lanes(out_img, left_fitx: np.array, right_fitx: np.array, ploty: np.array):
    """
    Convenience function to plot the lines found by sliding window search
    :param out_img: out_put image of the search
